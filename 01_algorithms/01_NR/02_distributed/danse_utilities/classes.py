...
class SROsTimeVariation:
    ...
    def __post_init__(self):
        # Equivalences
        if self.varRange == 0 or self.probVarPerSample == 0:
...
class ProgramSettings(object):
    ...
    diffuseNoise: bool = False  # if True, the noise appears diffuse
        # (same at every node), instead of generated by localised source(s).
