...
def main():
    ...
    SPP_threshold = 0.8
    # Exports
    # exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\onesource_reverberant' % os.getcwd()
    exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\onesource_anechoic' % os.getcwd()
    # exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\twosources_anechoic\\GEVDrank1' % os.getcwd()
    # exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\twosources_anechoic\\GEVDrank2' % os.getcwd()
    # exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\twosources_reverberant\\GEVDrank1' % os.getcwd()
    # exportDir = '%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\twosources_reverberant\\GEVDrank2' % os.getcwd()
    # ----- Acoustic scenario + specific speech/noise signal(s) selection (if empty, random selection)
    # ASref = 'J5_Ns1_Nn1\\AS9'       
    # ASref = 'J3Mk2_Ns1_Nn1\\testAS_anechoic'      
    # ASref = 'J3Mk2_Ns1_Nn1\\testAS'      
    ASref = 'J3Mk2_Ns2_Nn3\\testAS_anechoic'  
    # ASref = 'J3Mk2_Ns2_Nn3\\testAS'   
    # ASref = 'testAS_anechoic'     
    # ASref = ''                  
    # speech = ''                   
    ...
    y,ds,ny,t,Fs,J,reftxt = sig_gen.sig_gen(path_acoustic_scenarios,speech_in,Tmax,noise_type,baseSNR,\
                            pauseDur,pauseSpace,ASref,speech,noise,plotAS=None,\
                                plot_AS_dir='%s\\01_algorithms\\01_NR\\01_centralized\\01_MWF_based\\01_GEVD_MWF\\00_figs\\02_for_20211007meeting\\GIFs\\onesource' % os.getcwd(),\
                                    ms=multispeakers)
    ...
    print('\nComputing oracl5e VAD from clean speech signal...')
